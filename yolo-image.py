...
weightsPath = os.path.sep.join([args["yolo"], "YOLOv3/yolov3.weights"])
configurationPath = os.path.sep.join([args["yolo"], "YOLOv3/cfg/yolov3.cfg"])
...
lr = [lr[i[0] - 1] for i in model.getUnconnectedOutLayers()]
